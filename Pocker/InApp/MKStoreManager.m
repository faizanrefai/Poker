...
-(void) requestProductData
{
	SKProductsRequest *request= [[SKProductsRequest alloc] initWithProductIdentifiers:[NSSet setWithObjects:kFeatureA1Id,nil]];
...
//	{
//		SKProduct *product = [self.purchasableObjects objectAtIndex:i];
//		//NSString *s = [[product productIdentifier] sub]
//		NSRange range = [productIdentifier rangeOfString:[product productIdentifier]];	
//        NSLog([product productIdentifier]);
//         countText= [productIdentifier substringFromIndex:range.location+[[product productIdentifier] length]-1];
//
//	}
	NSRange range = [productIdentifier rangeOfString:kConsumableBaseFeatureId];	
	NSLog(kConsumableBaseFeatureId);
